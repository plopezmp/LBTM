...
to compute-utl-averages
  ifelse ticks >= 10 [
    ...
    ask readers with [reader-type = "sns"] [ set reader-utl (sigmoid (cycle / ticks) a1 b1) ]
    ask readers with [reader-type = "io"] [ set reader-utl (sigmoid (cycle / ticks) a2 b2) ]
    ask readers with [reader-type = "inv"] [ set reader-utl (sigmoid (cycle / ticks) a3 b3) ]
