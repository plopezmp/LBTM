...
to setup-globals
  ...
  set queue-file (word "queue-length-" num-checkouts "-" num-readers "-" minimum-stock-level "-" time-between-inventories "-" number-of-contention-intervals "-" behaviorspace-run-number ".txt")
  ...
  set p-loss-file (word "p-loss-" num-checkouts "-" num-readers "-" minimum-stock-level "-" time-between-inventories "-" number-of-contention-intervals "-" behaviorspace-run-number ".txt")
  ...
  set time-id-first-file (word "t-id-first-" num-checkouts "-" num-readers "-" minimum-stock-level "-" time-between-inventories "-" number-of-contention-intervals "-" behaviorspace-run-number ".txt")
  ...
  set known-file (word "known-ratio-" num-checkouts "-" num-readers "-" minimum-stock-level "-" time-between-inventories "-" number-of-contention-intervals "-" behaviorspace-run-number ".txt")
  ...
  set lookup-file (word "lookup-ratio" "-" num-checkouts "-" num-readers "-" minimum-stock-level "-" time-between-inventories "-" number-of-contention-intervals "-" behaviorspace-run-number ".txt")
...
@#$#@#$#@
<experiments>
  <experiment name="test_6x6_f_50R_1grp_45-10m" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    ...
    <metric>sum [num-of-collisions] of readers</metric>
    ...
    <steppedValueSet variable="ceiling-to-floor-distance" first="4.5" step="0.5" last="10"/>
  ...
  <experiment name="Height_2x2_20R" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    <metric>diameter-x</metric>
    ...
    <steppedValueSet variable="ceiling-to-floor-distance" first="3" step="0.5" last="10"/>
    <enumeratedValueSet variable="max-run-time">
      <value value="100000000"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="p-width">
  ...
  <experiment name="Height_3x3_20R" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    <metric>diameter-x</metric>
  ...
  <experiment name="Height_4x4_20R" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    <metric>diameter-x</metric>
  ...
  <experiment name="Height_5x5_20R" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    <metric>diameter-x</metric>
  ...
  <experiment name="Height_6x6_20R" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    <metric>diameter-x</metric>
  ...
  <experiment name="Height_7x7_20R" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    <metric>diameter-x</metric>
  ...
  <experiment name="Height_2x2_20R_1750" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    <metric>diameter-x</metric>
  ...
  <experiment name="Height_3x3_20R_2000" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    <metric>diameter-x</metric>
  ...
  <experiment name="test-mix-1" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>total-offered-load-of-tags</metric>
    <metric>total-offered-load-of-tags-sg</metric>
    <metric>total-offered-load-of-charts</metric>
    <metric>total-offered-load-of-charts-sg</metric>
    <metric>total-system-throughput-sg</metric>
    <metric>total-charts-thoughput-sg</metric>
    ...
    <metric>mean [ce-t] of allreaders-set / ticks</metric>
    <metric>mean [cs-t] of allreaders-set / ticks</metric>
    <metric>mean [cc-t] of allreaders-set / ticks</metric>
  ...
  <experiment name="cycles-t1" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>total-offered-load-of-tags</metric>
    <metric>total-offered-load-of-tags-sg</metric>
    ...
    <metric>total-outages</metric>
    <metric>sum [num-of-collisions] of readers</metric>
    <metric>sum [num-of-collisions] of checkouts</metric>
    <enumeratedValueSet variable="Q">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="sigma">
    ...
    <steppedValueSet variable="time-between-inventories" first="4" step="2" last="26"/>
    <enumeratedValueSet variable="min-power-to-feed-tag-IC">
      <value value="-17"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ceiling-to-floor-distance">
  ...
  <experiment name="stock-l1" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>total-offered-load-of-tags</metric>
    <metric>total-offered-load-of-tags-sg</metric>
    ...
    <steppedValueSet variable="minimum-stock-level" first="50" step="5" last="95"/>
    <enumeratedValueSet variable="max-inventory-cycles">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="height_2_tx">
  ...
  <experiment name="ratio_vs_T_1" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>avg-time-queue-of-tags</metric>
    <metric>avg-time-in-system-of-tags</metric>
    <metric>average-inv-ratio</metric>
    <metric>number-of-contention-intervals</metric>
    <metric>total-offered-load-of-tags</metric>
    <metric>total-offered-load-of-tags-sg</metric>
    <metric>total-offered-load-of-charts</metric>
    <metric>total-offered-load-of-charts-sg</metric>
    ...
    <enumeratedValueSet variable="number-of-contention-intervals">
      <value value="1"/>
      <value value="50"/>
      <value value="100"/>
      <value value="150"/>
  ...
  <experiment name="stock_delta1" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>avg-time-queue-of-tags</metric>
    <metric>avg-time-in-system-of-tags</metric>
  ...
  <experiment name="stock_delta100" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>avg-time-queue-of-tags</metric>
    <metric>avg-time-in-system-of-tags</metric>
  ...
  <experiment name="stock_delta200" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>avg-time-queue-of-tags</metric>
    <metric>avg-time-in-system-of-tags</metric>
  ...
  <experiment name="ratio_vs_T_26" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>avg-time-queue-of-tags</metric>
    <metric>avg-time-in-system-of-tags</metric>
  ...
  <experiment name="stock_delta1_26" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>avg-time-queue-of-tags</metric>
    <metric>avg-time-in-system-of-tags</metric>
  ...
  <experiment name="stock_delta100_26" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>avg-time-queue-of-tags</metric>
    <metric>avg-time-in-system-of-tags</metric>
  ...
  <experiment name="stock_delta200_26" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>avg-time-queue-of-tags</metric>
    <metric>avg-time-in-system-of-tags</metric>
